...
//text("hi",200,200)
        ...
        if(collision.collided){
          ...
          flag = 1
          Matter.Body.setPosition(balley1.body,{x:100 ,y: 145 });
          Matter.Body.setPosition(falley1.body,{x:700,y:145});
          myFunction();
         // alertFunc();
  ...
  console.log(mouseX)
    for(i=0;i<160;i=i+50){
     ...
     invi1 = new Ground(140,475,200,20);
     invi2 = new Ground(660,475,200,20);
       ...
       // balley.display()
        ...
        World.remove(world,plat1.body);
        World.remove(world,plat2.body);
        World.remove(world,plat3.body);
        World.remove(world,plat4.body);
        World.remove(world,plat5.body);
        World.remove(world,plat6.body);
        World.remove(world,plat7.body);
        World.remove(world,plat8.body);
        World.remove(world,plat9.body);
        World.remove(world,plat10.body);
        World.remove(world,balley.body);
        World.remove(world,falley.body);
        collision1 = Matter.SAT.collides(balley1.body,invi1.body)
        if(collision1.collided){
          
          flag2 = 1
        
        }
        collision2 = Matter.SAT.collides(balley1.body,invi2.body)
        ...
        falley1.display();
        balley1.display();
        collision3 = Matter.SAT.collides(balley1.body,falley1.body)
